...
namespace PactV2
{
    ...
    public partial class Contract
    {
        public static Contract FromJson(string json) => JsonSerializer.Deserialize<Contract>(json, PactV2.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Contract self) => JsonSerializer.Serialize(self, PactV2.Converter.Settings);
    }
